...
function Header ({ onSubmit, cartCount }: Props): ReactElement {
    return (
        <header className="bg-primary flex flex-col p-4 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
            <div className="flex items-center justify-between w-full mb-8 lg:mb-0 lg:contents">
                <Link to="/" className="text-white font-bold ml-4 lg:ml-4 lg:order-1 lg:shrink-0">
                    Tech shop
                </Link>
                <Link to="/cart" >
                <div className="lg:order-3 lg:shrink-0">
